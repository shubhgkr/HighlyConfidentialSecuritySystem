...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<body>
		...
		<center>
		<h3>
			<span class=subHead><br />Add Pancard Details</span>
		</h3>
		</center>

		<form action="./addPancardDetailsAction.do" name="pan" method='post'
			onsubmit="return validate()">
			<!--<table border="1"><tr><td></td></tr></table>-->
			<center>
		<h3>
			<span class=subHead><br /><font color='white'>Add Pancard Details</font></span>
		</h3>
		</center>
			<table border='0' align="center" width=40% >
				...
				<tr>
					...
					<td>
						<input type="text" name="accname" value="" size="20" />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
					<td></td>
					<td></td>
				...
				<tr>
					...
					<td>
						<input type="text" name="issuedate" value="" size="20" />
						<a
...
frmvalidator
		.addValidation("accname", "req", "Please enter your Account Name");
